<template>
  ...
  <header class="  items-center justify-between h-full flex flex-col" >
        ...
        <div class=" h-5/6 w-auto flex flex-col ">
          <button class="transition duration-500 ease-in-out button-menu transform hover:-translate-x-3 hover:scale-x-125"  >
        ...
        <div class="space-y-3 justify-end">
          <button @click="toLink(facebook)" class="icon-title block">
          ...
          <button @click="toLink(ig)" type="button" class=" icon-title block">
          ...
          <button @click="toLink(git)"  type="button" class="icon-title block">
