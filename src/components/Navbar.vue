<template>
  ...
  <header class="  items-center justify-between h-full flex flex-col" >
        ...
        <div class="space-y-4 justify-end">
          <button @click="toLink(facebook)" class="icon-title block hover-navbar-icon">
          ...
          <button @click="toLink(ig)" type="button" class="icon-title block hover-navbar-icon">
          ...
          <button @click="toLink(git)"  type="button" class="icon-title block hover-navbar-icon">
